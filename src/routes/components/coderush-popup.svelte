...
{#if showPopup}
  <div
    ...
    class="fixed top-0 left-0 w-screen h-screen bg-black/50 z-50 flex justify-center items-center"
  ...
  >
    <div
      ...
      aria-hidden="true"
      class="relative overflow-hidden dark:text-gray-300 dark:bg-slate-900 flex items-center p-4 flex-col max-w-xl bg-slate-100 text-gray-700 w-full rounded-md shadow-2xl"
    >
      ...
      <DottedBgText>Coderush'24</DottedBgText>

      <p
        class="text-center mb-12 mx-16 text-gray-700 dark:text-gray-300 text-sm"
      >
      ...
      <p class="text-xs mb-12 whitespace-nowrap text-gray-400">
        Compete and challenge you coding skills
      </p>

      <div class="flex w-full justify-between mb-8 items-center px-16">
        <img
          src={qr_code}
          alt="coderush24 registraion"
          class="h-40 bg-white rounded-md aspect-square"
        />

        <div class="flex flex-col text-sm items-start">
          <h3 class="text-gray-200 font-bold">Registration deadline:</h3>
          <p class="text-gray-400">Thursday, 8 February 2024</p>
        </div>
      </div>

      <div class="flex items-center w-full justify-end gap-3">
        <p class="text-gray-400 text-xs">google_dsc_itu</p>
        <a
          href="https://www.instagram.com/google_dsc_itu/?hl=en"
          class="h-4 aspect-square text-gray-400"><FaInstagram /></a
        >
      </div>
      ...
      <img
        src={CelebrationStar}
        alt="celebration"
        class="absolute left-28 top-8 h-20 aspect-square"
      />
    </div>
  </div>
{/if}
